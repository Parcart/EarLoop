...
EarLoop обрабатывает системный звук Windows в реальном времени и помогает создать индивидуальный профиль эквализации с помощью последовательных A/B-сравнений.
...
EarLoop предлагает два варианта эквализации. Пользователь сравнивает их на текущем аудиоматериале и выбирает предпочтительный вариант.
