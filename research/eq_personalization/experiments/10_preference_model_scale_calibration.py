...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="V4a.2: scale calibration for online Logistic Preference Model."
    )
    parser.add_argument(
        "--dataset",
        type=str,
    ...
    parser.add_argument("--prefix", type=str, default="notebook_v4a2_preference_model_calibration")
    parser.add_argument(
...
def main() -> None:
    ...
    source_summary = summarize_calibration_heldout_by_source(heldout_pairs)
    ...
    print("Saved V4a.2 scale calibration outputs to:", output_dir)
    print(summary)
    print("\nHeld-out by source:")
