...
COMMAND_ALIASES: dict[str, CommandName] = {
    ...
    "get_audio_bridge_health": "get_audio_bridge_health",
    "get_audio_status": "get_audio_status",
    "get_runtime_profile_status": "get_runtime_profile_status",
    "get_session_preview_status": "get_session_preview_status",
    "get_domain_worker_health": "get_domain_worker_health",
    "apply_engine_config": "apply_engine_config",
    "sync_runtime_profile": "sync_runtime_profile",
    "apply_session_preview": "apply_session_preview",
    "resolve_session_preview_target": "resolve_session_preview_target",
    ...
    "shutdown_audio_bridge": "shutdown_audio_bridge",
    "shutdown_domain_worker": "shutdown_domain_worker",
    ...
    "getAudioBridgeHealth": "get_audio_bridge_health",
    "getAudioStatus": "get_audio_status",
    "getRuntimeProfileStatus": "get_runtime_profile_status",
    "getSessionPreviewStatus": "get_session_preview_status",
    "getDomainWorkerHealth": "get_domain_worker_health",
    "applyEngineConfig": "apply_engine_config",
    "syncRuntimeProfile": "sync_runtime_profile",
    "applySessionPreview": "apply_session_preview",
    "resolveSessionPreviewTarget": "resolve_session_preview_target",
    ...
    "shutdownAudioBridge": "shutdown_audio_bridge",
    "shutdownDomainWorker": "shutdown_domain_worker",
}
